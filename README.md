...
Open obstacle_detector.ino in the Arduino IDE
Install the IRremote library (v3.x) via Library Manager
Wire all components according to the pin reference table above
Upload the sketch to your ELEGOO Uno R3
Open Serial Monitor at 115200 baud for debug output (optional)
...
Dayyan Malik Computer Engineering — Georgia State University LinkedIn · GitHub
